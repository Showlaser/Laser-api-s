...
namespace Auth_API.Tests.UnitTests.TestModels
{
    public class TestUserDto
    {
        public readonly UserDto UserDto = new()
        {
            ...
            Salt = new byte[] { 9, 56, 170, 130, 207, 155, 114, 238, 17, 118, 10, 169, 31, 122, 183, 187, 25, 158, 80, 203, 215, 174, 223, 231, 88, 54, 223, 133, 148, 161, 121, 6, 150, 157, 203, 229, 246, 18, 184, 3, 147, 227, 116, 169, 121, 179, 147, 165, 115, 111, 187, 183, 25, 194, 160, 34, 130, 206, 41, 173, 219, 41, 16, 251 },
        };
    }
}
